...
var goalDB : [Goal] = [
    ...
    Goal(title: "Accept invitation to any social gathering", description: "You are always up declining invites to any social situation out of your comfort-zone, stop it and be open to other social gathering, you can learn new stuff, met new people, and discover new part of your personality, start accepting the next 5 invitation."),
